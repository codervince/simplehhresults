...
# l.add_xpath('FinishTime', './td[11]/text()')
     ...
     # #        ).groupdict()['raceclass']
        ...
        meta_dict = {
            ...
            'stdsec1':stdsec5,
            'stdsec1':stdsec6,
            'sp1f2f3f_windiv' : sp1f2f3f_windiv,
            'sp4f5f6f_windiv' : sp4f5f6f_windiv,
            'sp7f8f9f_windiv' : sp7f8f9f_windiv,
            'sp10f11f12f_windiv' : sp10f11f12f_windiv,
            # 'raceindex': raceindex,
            # 'racegoing': racegoing,
            # 'raceclass': raceclass,
            'horsenos': horsenos,
    ...
    def parse_sectional_time(self, response):		
        ...
        for line_selector, time_selector in zip(horse_lines_selector,sectional_time_selector):
            ...
            sp1f2f3f_windiv = response.meta['sp1f2f3f_windiv'],
            sp4f5f6f_windiv = response.meta['sp4f5f6f_windiv'],
            sp7f8f9f_windiv = response.meta['sp7f8f9f_windiv'],
            sp10f11f12f_windiv = response.meta['sp10f11f12f_windiv'],
